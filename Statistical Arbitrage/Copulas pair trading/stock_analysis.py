...
def main():
    ...
    use_stock_predictor(_company_name, _start, _end, _future, _metrics, _plot, _out_dir)
...
if __name__ == "__main__":
    ...
    _start = "2020-01-01"
    _end = "2023-01-01"
    _future = 5 # how many days into the future it predicts
    _metrics = True
    _plot = True
    _out_dir = "/Users/jasperchong/PycharmProjects/Statistical Arbitrage/Copulas pair trading/test"
